...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterUncreatableType<DebInstaller>("Matsya.DebInstaller", 1, 0,
                                             "DebInstaller", "error");

    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/matsya-debinstaller/translations/").arg(locale.name());
    ...
    qmlRegisterUncreatableType<DebInstaller>("Matsya.DebInstaller", 1, 0, "DebInstaller", "error");
